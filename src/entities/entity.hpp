                             ...
                             int playerSpriteSheetY = 0)
{
	...
	ecs.addComponent(base, Collider{TILE_SIZE, TILE_SIZE*BASE_ENTITY_HEIGHT}); //adding size here as currently all entities have the same size and most entities will probably always be humans of size 2 anyway
