...
struct Weapon {
	// // Some metadata is probably required or weapon as entity but feels unnecessary, when not on map.
	// std::string name;
	...
	int warmUp;				// or aimtime? Could be nice to simulate handling, at least when aiming
